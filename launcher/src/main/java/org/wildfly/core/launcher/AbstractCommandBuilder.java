...
abstract class AbstractCommandBuilder<T extends AbstractCommandBuilder<T>> implements CommandBuilder {
     ...
     *
     * @param javaOpt the JVM argument to add
     *
     * @return the builder
     */
    public abstract T addJavaOption(final String javaOpt);
     ...
     * @return the builder
     */
    public T addJavaOptions(final String... javaOpts) {
        if (javaOpts != null) {
     ...
     * @return the builder
     */
    public T addJavaOptions(final Collection<String> javaOpts) {
        if (javaOpts != null) {
            for (String javaOpt : javaOpts) {
                addJavaOption(javaOpt);
            }
     ...
     * @return the builder
     */
    public T setJavaOptions(final Collection<String> javaOpts) {
        this.javaOpts.clear();
     ...
     * @return the builder
     */
    public T setJavaOptions(final String... javaOpts) {
        this.javaOpts.clear();
        return addJavaOptions(javaOpts);
    }
     ...
     * @return the builder
     */
    public T setMulticastAddress(final String address) {
    ...
    public T setManagementBindAddress(final String address) {
        addServerArg("-bmanagement", address);
        return getThis();
    }
    ...
    protected void addJavaOption(final Argument arg) {
        javaOpts.add(arg);
    }
