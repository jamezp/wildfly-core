 ...
 */
public interface LogContextConfiguration extends AutoCloseable {
    ...
    class Factory {
         ...
         */
        public static LogContextConfiguration create(final ContextConfiguration contextConfiguration) {
            return new LogContextConfigurationImpl(contextConfiguration);
        }
    }
}
