...
public class ObjectBuilder<T> {
     ...
     * @return a supplier which can create the object
     */
    private T construct(final String moduleName, final Map<String, String> constructorProperties, final Map<String, String> properties, final Set<String> postConstructMethods) {
        if (className == null) {
            throw new IllegalArgumentException("className is null");
        }
